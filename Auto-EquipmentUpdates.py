# This script automates a documentation process by sending a POST request that updates a large group of equipment based on User input. Script documents results on excel sheet and in database.
